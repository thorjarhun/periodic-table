...
//function restart() {
  ...
  var subsection_tiles_enter = subsection_tiles.enter()
    .append('g');

  var tiles = subsection_tiles_enter.selectAll('g')
...
function showDetails(carrier) {
  ...
  var subsection_details = section_details.selectAll('g')
    .data([carrier], keyFunc);
